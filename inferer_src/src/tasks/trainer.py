...
def train_and_fit(args):
    ...
    criterion = nn.CrossEntropyLoss(weight=torch.tensor([0.38,4.04,7.75]),ignore_index=-1)
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        test_f1_per_epoch.append(results['f1']) ###only test
