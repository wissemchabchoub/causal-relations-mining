...
def preprocess_semeval2010_8(args):
    ...
    df_train.relations[np.logical_and(df_train.relations!='Cause-Effect(e2,e1)\n'
                                      ,df_train.relations!='Cause-Effect(e1,e2)\n')]='Other\n'
    
    df_test.relations[np.logical_and(df_test.relations!='Cause-Effect(e2,e1)\n'
                                      ,df_test.relations!='Cause-Effect(e1,e2)\n')]='Other\n'
